...
import {
  ...
  FlaskConical, Zap, Receipt, Images, Sparkles, Mail,
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/onboarding',  icon: Sparkles,        label: 'Onboarding',  group: 'ops'  },
  ...
  { to: '/email-alerts', icon: Mail,           label: 'Email Alerts', group: 'ops'  },
];
